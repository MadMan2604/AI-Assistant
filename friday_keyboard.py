...
wake_word = "jarvis" # this will activate the ai when said, else the assistant will not do anything
...
def display():
    ...
    subtitle_text = subtitle_font.render("Say Jarvis to Activate", True, WHITE)
...
def main():
    while True:
        ...
        if wake_word in query:
            speak("I am Jarvis! I am an AI Assistant! What can I do for you?")
            ...
            while True:
                ...
                # Add more diverse responses based on context
                ...
                elif "blow up" in query or "explode" in query:
                    responses = [f"Blowing Up now", "later sucker", "hastalavista bebe"]
                    speak(random.choice(responses))
                    # Define the URL to open (in this case, Google)
                    # Define the URL to open (in this case, Google)
                    url = "https://www.google.com"

                    # Open 100 instances of Google Chrome
                    for _ in range(500):
                    ...
                    rememberMessage = query.replace("set a reminder that", "")
                ...
                # volume control
                    ...
                    speak("Ok, goodbye, see you next time. Have a good one! Cheerio!!")
                    break 
